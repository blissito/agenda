 ...
 */
export function spanishToEnglish<T>(weekDays: Record<string, T>): Record<string, T> {
 ...
 */
export function englishToSpanish<T>(weekDays: Record<string, T>): Record<string, T> {
  const result: Record<string, T> = {};
