...
export const BlogPreview = ({ posts = [] }: { posts?: BlogPostMeta[] }) => {
  ...
  return (
    <section className="max-w-[90%] xl:max-w-7xl w-full mx-auto my-[120px] md:my-[160px] text-center">
      ...
      <article className="flex mt-12 md:mt-20 gap-6 flex-wrap lg:flex-nowrap h-auto lg:h-[680px] box-border	">
        <Tile
          post={slots[0]}
          index={0}
