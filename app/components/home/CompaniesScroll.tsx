...
export const CompaniesScroll = ({ ...props }: { props?: unknown }) => (
  <section className=" relative ">
    <h2 className="group overlay text-4xl lg:text-6xl font-bold leading-normal sticky top-[32%] w-[90%] lg:w-[70%] mx-auto flex flex-wrap items-center text-center justify-center ">
