...
export const CompaniesScroll = ({ ...props }: { props?: unknown }) => (
  <section className=" relative ">
    <h2 className="group overlay !leading-snug text-4xl lg:text-6xl font-satoBold  sticky top-[32%] w-full md:w-[70%] mx-auto flex flex-wrap items-center text-center justify-center ">
