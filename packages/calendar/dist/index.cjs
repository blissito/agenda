...
var Column = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { ref: columnRef, className: "grid relative", children: [
    ...
    showNowLine && /* @__PURE__ */ jsxRuntime.jsx(
      "div",
      {
        className: "absolute left-0 right-0 z-20 pointer-events-none",
        style: { top: nowTop },
        children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center", children: [
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: "w-2.5 h-2.5 rounded-full -ml-1", style: { backgroundColor: "#5158F6" } }),
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: "h-0.5 flex-1", style: { backgroundColor: "#5158F6" } })
        ] })
      }
    )
  ] });
