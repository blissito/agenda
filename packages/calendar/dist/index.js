...
import { useSensors, useSensor, PointerSensor, KeyboardSensor, DndContext, pointerWithin, DragOverlay, useDroppable, useDraggable } from '@dnd-kit/core';
...
var ParticipantAvatars = ({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex -space-x-1 mt-1", children: [
    visible.map((participant) => /* @__PURE__ */ jsx(
      "div",
      {
        className: cn(
        ...
        children: participant.avatar ? /* @__PURE__ */ jsx(
          "img",
          {
        ...
        ) : /* @__PURE__ */ jsx("span", { className: "font-medium text-gray-600", children: participant.name?.charAt(0)?.toUpperCase() || "?" })
      },
      participant.id
    )),
    remaining > 0 && /* @__PURE__ */ jsxs(
      "div",
      {
...
var DayHeader = ({
  ...
  return /* @__PURE__ */ jsxs("p", { className: "grid place-items-center", children: [
    /* @__PURE__ */ jsx("span", { className: "capitalize text-[11px] md:text-base", children: date.toLocaleDateString(locale, { weekday: "short" }) }),
    /* @__PURE__ */ jsx(
      "span",
      {
        className: cn(
...
function Calendar({
  ...
  return /* @__PURE__ */ jsxs(
    DndContext,
    {
      ...
      children: [
        /* @__PURE__ */ jsx("article", { className: "w-full bg-white shadow rounded-xl", children: /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxs(
                "section",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsx("p", { children: /* @__PURE__ */ jsx("span", { className: cn("text-sm text-gray-500", isMobile && "text-[8px] leading-tight"), children: isResourceMode ? "" : Intl.DateTimeFormat().resolvedOptions().timeZone }) }),
              ...
              /* @__PURE__ */ jsxs(
                "section",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsx(TimeColumn, { hoursStart, hoursEnd, cellHeight: CELL_H, compact: isMobile }),
        ...
        /* @__PURE__ */ jsx(DragOverlay, { children: activeEvent ? /* @__PURE__ */ jsx(EventOverlay, { event: activeEvent, config }) : null })
      ]
    }
  );
}
...
var TimeColumn = ({
  ...
  return /* @__PURE__ */ jsx(Cell, { cellHeight, children: /* @__PURE__ */ jsx("span", { className: cn(compact && "text-[11px]"), children: `${hour < 10 ? "0" : ""}${hour}:00` }) }, hour);
}) });
var DraggableEvent = ({
  event,
  onClick,
...
var DefaultExportIcon = () => /* @__PURE__ */ jsx("svg", { viewBox: "0 0 24 24", className: "w-5 h-5", fill: "none", stroke: "currentColor", strokeWidth: 2, children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" }) });
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
          ...
          showExport && /* @__PURE__ */ jsx(
            "button",
            {
              ...
              "aria-label": "Export",
              children: exportIcon ?? /* @__PURE__ */ jsx(DefaultExportIcon, {})
            }
          ),
